...
namespace Islem
{
    public class LisansOgrenci : IOgrenci
    {
        ...
        {
            Console.WriteLine("Lisans öğrencisine yeni ders eklendi");
        }

        public List<IDers> TranskriptHesapla(List<IDers> dersListe)
        {
            Console.WriteLine("Lisans öğrencisi için transkript hesaplandı");
